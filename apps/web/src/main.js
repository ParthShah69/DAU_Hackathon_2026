...
function marketplace() {
  ...
  const ownershipControls = canManageListings(detail) ? `<form class="listing-edit-form"><label class="field-label">Listing name</label><input name="name" value="${escapeHtml(detail.title)}" required /><button class="outlined-button" type="submit">Save listing name</button></form>${button('Publish after server validation', 'button button-dark', 'publish-listing')}` : '<p class="field-hint">Read-only listing. Only the supplier organization can edit or publish it.</p>'

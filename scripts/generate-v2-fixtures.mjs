...
async function main() {
  ...
  const manifest = record('fixture_manifest', 'v2-demo', {
    ...
    runtime_seed_compatibility: {
      path: 'apps/api/data/demo/marketplace.json',
      schema_version: '2.0',
      source_id: 'carbonbridge-demo-seed-v2',
      source_kind: 'synthetic_demo',
      fixed_clock: fixtureClock,
      note: 'The dependency-free API prototype keeps a human-readable adapter seed. Its semantic gates are checked alongside this UUIDv5 fixture package.',
    },
